...
/* package cells-0.1.0.0 */
#ifndef VERSION_cells
#define VERSION_cells "0.1.0.0"
#endif /* VERSION_cells */
#ifndef MIN_VERSION_cells
#define MIN_VERSION_cells(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_cells */
...
#define CURRENT_COMPONENT_ID "cells-0.1.0.0-inplace-cells"
